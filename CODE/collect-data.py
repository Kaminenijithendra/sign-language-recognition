...
while True:
    ...
    cv2.putText(frame,"SIX: "+str(count['six']), (10,240),cv2.FONT_HERSHEY_PLAIN,1,(0,225,255),1)
    cv2.putText(frame, "SEVEN: " + str(count['seven']), (10, 260), cv2.FONT_HERSHEY_PLAIN, 1, (0, 225, 255), 1)
    cv2.putText(frame, "EIGHT: " + str(count['eight']), (10, 280), cv2.FONT_HERSHEY_PLAIN, 1, (0, 225, 255), 1)
    cv2.putText(frame, "NINE: " + str(count['nine']), (10, 300), cv2.FONT_HERSHEY_PLAIN, 1, (0, 225, 255), 1)
